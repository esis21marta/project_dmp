...
latex_documents = [
    (master_doc, "dmp.tex", "dmp Documentation", "QuantumBlack", "manual",)
]
...
man_pages = [(master_doc, "dmp", "dmp Documentation", [author], 1,)]
