...
class TestFeaworkUniqueCount:
    def test_fea_work_unique_count(self, spark_session: SparkSession):
        ...
        actual_fea_df = mobility_work_stay_unique_count_features(work_agg_df)
