...
class TestFeaHomePoi:
    @mock.patch(
        "src.dmp.pipelines.dmp._04_features.mobility.nodes.fea_home_poi.calc_distance_bw_2_lat_long",
    )
    @mock.patch(
        "src.dmp.pipelines.dmp._04_features.mobility.nodes.fea_home_poi.neighbors",
        return_value=[
            ["qqu5e", "qqu5j", "qqu5k", "qqu6a", "qqu6b", "qqu6c", "qquc1", "qquc4"]
        ],
        autospec=True,
    )
    def test_fea_home_poi(
        self,
        mock_neighbors,
        ...
        mock_calc_distance_bw_2_lat_long.return_value = spark_session.createDataFrame(
            ...
            schema=StructType(
                [
                    ...
                    StructField("home1_duration", LongType(), True),
        ...
        actual_fea_df = mobility_home_poi_features(home_agg_df, poi_agg_df)
        ...
        expected_fea_df = spark_session.createDataFrame(
            ...
            schema=StructType(
                [
                    ...
                    StructField("mo_id", StringType(), False),
                    StructField(
                        "fea_mobility_home_cat_1_commercial_min_poi_dist",
                        DoubleType(),
                        True,
                    ),
                    StructField(
                        "fea_mobility_home_cat_1_commercial_poi_1km_num",
                        LongType(),
                        True,
                    ),
                    StructField(
                        "fea_mobility_home_cat_2_commercial_min_poi_dist",
                        DoubleType(),
                        True,
                    ),
                    StructField(
                        "fea_mobility_home_cat_2_commercial_poi_1km_num",
                        LongType(),
                        True,
                    ),
                ]
