...
def create_pipeline():
    return Pipeline(
        [
            ...
            node(
                join_tables,
                ["exploratory_segmentation_msisdns", "location_home_clean", "kr_clean"],
                "location_home_master_table",
            ),
            node(
                get_home_location_cross_tabs,
                "location_home_master_table",
                "exploratory_home_location_cross_tabs",
            ),
        ]
    )
