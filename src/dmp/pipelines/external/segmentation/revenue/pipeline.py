...
def create_pipeline():
    return Pipeline(
        [
            ...
            node(summarize_revenues, "revenue_sums", "exploratory_revenue_summary",),
            node(bin_revenues, "revenue_sums", "revenue_bins",),
            node(
                join_tables,
                ["exploratory_segmentation_msisdns", "revenue_bins", "kr_clean"],
                "revenue_master_table",
            ),
            node(
                get_revenue_cross_tabs,
                "revenue_master_table",
                "exploratory_revenue_cross_tabs",
            ),
        ]
    )
