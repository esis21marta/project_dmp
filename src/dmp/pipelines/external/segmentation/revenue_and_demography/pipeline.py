...
from src.dmp.pipelines.external.segmentation.revenue_and_demography.nodes import (
    clean_filter_demography,
    get_revenue_and_demography_cross_tabs,
    join_revenue_to_demography,
)
    ...
    return Pipeline(
        [
            ...
            node(
                ...
                "demography_clean_filtered",
            ),
            node(
                join_revenue_to_demography,
                ["demography_clean_filtered", "revenue_bins"],
                "revenue_and_demography",
            ),
            node(
                join_tables,
                [
                ...
                "revenue_and_demography_master_table",
            ),
            node(
                get_revenue_and_demography_cross_tabs,
                "revenue_and_demography_master_table",
                "exploratory_revenue_and_demography_cross_tabs",
            ),
        ]
    )
