...
def create_pipeline(**kwargs) -> Pipeline:
    ...
    """
    This function returns a pipeline which executes the necessary nodes to create the feature layer for `internet usage` after the data
    ...
    Returns:
        A Pipeline object containing all the `internet usage` nodes to execute the `feature` layer.
    """

    return Pipeline(
        [
            node(
                func=compute_rolling_window_calculations,
                inputs=[
                ...
                outputs="l2_internet_usage_prep",
                name="feat_internet_data_usage",
                tags=["fea_scoring_pipeline", "scoring_pipeline"],
            ),
            node(
                func=feat_internet_data_usage_full,
                inputs=[
                ...
                outputs="l2_internet_usage",
                name="fea_internet_usage",
                tags=["fea_scoring_pipeline", "scoring_pipeline"],
            ),
            node(
                func=fea_int_usage_covid_trend,
                inputs=[
                    "l1_internet_usage_scaffold_weekly",
                    "params:config_feature",
                    "params:features_mode",
                ...
                outputs="l5_fea_internet_usage_covid_trend",
                name="fea_internet_usage_covid_trend",
            ),
            node(
                func=fea_int_usage_covid,
                inputs=[
                    "l1_internet_usage_scaffold_weekly",
                ...
                outputs="l5_fea_internet_usage_covid_final",
                name="fea_internet_usage_covid_final",
            ),
        ],
        tags=[
            "fea_internet_usage",
...
def create_covid_pipeline(**kwargs) -> Pipeline:
    ...
    return Pipeline(
        [
            node(
                func=fea_int_usage_covid_fixed("pre_covid"),
                inputs=[
                    "l4_internet_usage_scaffold_weekly_pre_covid",
                    "params:config_feature",
                    "params:pre_covid_last_weekstart",
                ],
                outputs="l5_fea_internet_usage_pre_covid_fixed",
                name="fea_internet_usage_pre_covid_fixed",
            ),
            node(
                func=fea_int_usage_covid_fixed("covid"),
                inputs=[
                    "l4_internet_usage_scaffold_weekly_covid",
                    "params:config_feature",
                    "params:covid_last_weekstart",
                ],
                outputs="l5_fea_internet_usage_covid_fixed",
                name="fea_internet_usage_covid_fixed",
            ),
            node(
                func=fea_int_usage_covid_fixed("post_covid"),
                inputs=[
                    "l4_internet_usage_scaffold_weekly_post_covid",
                    "params:config_feature",
                    "params:post_covid_last_weekstart",
                ],
                outputs="l5_fea_internet_usage_post_covid_fixed",
                name="fea_internet_usage_post_covid_fixed",
            ),
            node(
                func=fea_int_usage_covid_fixed_all,
                inputs=[
                    "l5_fea_internet_usage_pre_covid_fixed",
                ...
                outputs="l5_fea_internet_usage_covid_fixed_joined",
                name="fea_internet_usage_covid_fixed_joined",
            ),
        ],
        tags=["fea_internet_usage_covid", "de_feature_covid_pipeline",],
    )
