...
def create_pipeline(**kwargs) -> Pipeline:
    """
    This function returns a pipeline which executes the necessary nodes to create the feature layer for `Voice Calling` after the data
    ...
    Returns:
        A Pipeline object containing all the `Voice Calling` nodes to execute the `feature` layer.
    """
    return Pipeline(
        [
            node(
                func=fea_voice_calling,
                inputs=[
                ...
                outputs="l4_fea_voice_calling",
                name="fea_voice_calling",
                tags=["fea_scoring_pipeline", "scoring_pipeline"],
            ),
            node(
                func=fea_voice_calling_covid_final,
                inputs=[
                    "l2_voice_calling_time_series_filled",
                ...
                outputs="l5_fea_voice_calling_covid_final",
                name="fea_voice_calling_covid_final",
            ),
        ],
        tags=[
            "fea_voice_calling",
    ...
    return Pipeline(
        [
            node(
                ...
                outputs="l5_fea_voice_calling_covid",
                name="fea_voice_calling_covid",
            ),
        ],
        tags=["fea_voice_calling_covid", "de_feature_covid_pipeline"],
    )
