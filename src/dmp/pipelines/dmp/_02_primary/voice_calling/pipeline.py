...
def create_pipeline(**kwargs) -> Pipeline:
    """
    This function returns a pipeline which executes the necessary nodes to create the primary layer for `Voice Calling` after the data
    ...
    Returns:
        A Pipeline object containing all the `Voice Calling` nodes to execute the `primary` layer.
    """
    return Pipeline(
        [
            node(
                ...
                outputs="l2_voice_calling_weekly_aggregated_filtered",
                name="filter_partner_data_voice_calling",
            ),
            node(
                ...
                outputs="l2_voice_calling_time_series_filled",
                name="fill_time_series_voice_calling",
            ),
        ],
        tags=[
            "prm_voice_calls",
    ...
    return Pipeline(
        [
            ...
            node(
                ...
                outputs="l3_voice_calling_weekly_aggregated_filtered_pre_covid",
                name="filter_partner_data_voice_calling_pre_covid",
            ),
            node(
                func=fill_time_series(),
                inputs=[
                ...
                outputs="l4_voice_calling_time_series_filled_pre_covid",
                name="fill_time_series_voice_calling_pre_covid",
            ),
            # COVID-19
            node(
                func=filter_partner_data_fixed_weekstart,
                ...
                outputs="l3_voice_calling_weekly_aggregated_filtered_covid",
                name="filter_partner_data_voice_calling_covid",
            ),
            node(
                func=fill_time_series(),
                inputs=[
                ...
                outputs="l4_voice_calling_time_series_filled_covid",
                name="fill_time_series_voice_calling_covid",
            ),
            # Post COVID-19
            node(
                func=filter_partner_data_fixed_weekstart,
                ...
                outputs="l3_voice_calling_weekly_aggregated_filtered_post_covid",
                name="filter_partner_data_voice_calling_post_covid",
            ),
            node(
                func=fill_time_series(),
                inputs=[
                ...
                outputs="l4_voice_calling_time_series_filled_post_covid",
                name="fill_time_series_voice_calling_post_covid",
            ),
        ],
        tags=["prm_voice_calls_covid", "voice_calls_covid_pipeline", "prm_covid",],
    )
