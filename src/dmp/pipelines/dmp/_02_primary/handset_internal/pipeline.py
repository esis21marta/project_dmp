...
def create_pipeline(**kwargs) -> Pipeline:
    """
    This function returns a pipeline which executes the necessary nodes to create the primary layer for `Hanset for internal` after the data
    ...
    Returns:
        A Pipeline object containing all the `Hanset for internal` nodes to execute the `primary` layer.
    """
    return Pipeline(
        [
            node(
                ...
                outputs="l2_device_internal_weekly_aggregated_filtered",
                name="filter_partner_data_handset_internal",
            ),
            node(
                ...
                outputs="l2_internal_handset_time_series_filled",
                name="fill_time_series_handset_internal",
            ),
        ],
        tags=[
